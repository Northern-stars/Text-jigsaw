"""Test a trained MangaZero panel-ordering solver on a chosen split."""
...
from Solver.agent.mangazero_set2seq_solver import MangaZeroSetToSequenceSolver
from Solver.env.mangazero_panel_env import MangaZeroPanelOrderingDataset, collate_panel_ordering_batch
from Solver.train_mangazero_panel_ordering import evaluate, format_split_metrics, parse_split_ratio, split_dataset


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Test a MangaZero panel-ordering checkpoint.")
...
def build_model(panel_count: int, config: dict[str, Any], use_layout: bool) -> MangaZeroSetToSequenceSolver:
    return MangaZeroSetToSequenceSolver(
