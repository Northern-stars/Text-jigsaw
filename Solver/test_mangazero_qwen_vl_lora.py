"""Evaluate a Qwen2.5-VL + LoRA MangaZero ordering checkpoint."""
...
from Solver.train_mangazero_qwen_vl_lora import build_model, evaluate, load_checkpoint


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Test a Qwen2.5-VL + LoRA MangaZero ordering checkpoint.")
